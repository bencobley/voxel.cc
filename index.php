                        ...
                        <div class="d-flex h-100 text-center align-items-center">
                            <div class="w-100 text-white">
                                <h1 class="pt-5">Own Your <br> Smart Home</h1>
                                    <a class="btn btn-lg btn-primary" data-toggle="modal" data-target="#videoModal" data-video="https://voxelmedia.s3.eu-west-2.amazonaws.com/HP/video.mp4?&autoplay=1">Watch our video!</a>
                            </div>
                        </div>
                    </div>
                </header>
